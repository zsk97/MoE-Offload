        ...
        do
            ...
            do
                schedule_size=$((2 * batch_size))
                    ...
                    output=$(python examples/benchmark_schedule.py --model_path=/home/tangzhenheng/hexin/data/switch-base-finetuned-wmt16/switch-base-32 \
        ...
        do
            ...
            do
                schedule_size=$((2 * batch_size))
                    ...
                    output=$(python examples/benchmark_schedule.py --model_path=/home/tangzhenheng/hexin/data/switch-base-finetuned-wmt16/switch-base-64 \
                                                    --offload_size=$offload_size \
                                                    --batch_size=$batch_size \
                                                    $predict_arg \
                                                    $in_order_arg \
        ...
        do
            ...
            do
                schedule_size=$((2 * batch_size))
                    ...
                    output=$(python examples/benchmark_schedule.py --model_path=/home/tangzhenheng/hexin/data/switch-base-finetuned-wmt16/switch-base-128 \
                                                    --offload_size=$offload_size \
                                                    --batch_size=$batch_size \
                                                    $predict_arg \
                                                    $in_order_arg \
